...
func _ready() -> void:
	...
	# Chama o diálogo do Leozin
	EventBus.dialogue_requested.emit("interrogation_day3")
...
func _on_speaker_changed(character_name: String) -> void:
	# O nome exato que está no banco de dados para o Dia 3
...
func _on_dialogue_finished() -> void:
	...
	print("[INVESTIGAÇÃO] Diálogo do Dia 3 encerrado. Avançando para o próximo dia...")
	
	# 1. Avisa o GameManager que o dia terminou com sucesso (soma +1, indo para o Dia 4)
