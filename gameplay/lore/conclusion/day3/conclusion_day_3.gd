...
func _ready() -> void:
	...
	# MUDANÇA 1: Chama o diálogo de desfecho do Nathan
	EventBus.dialogue_requested.emit("conclusion_nathan")
...
func _on_dialogue_finished() -> void:
	...
	print("[CONCLUSÃO] Caso encerrado. Indo trabalhar no Dia 3...")
	
	# Mandamos o jogador direto para a gameplay do Dia 3.
